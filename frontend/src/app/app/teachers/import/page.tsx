...
export default function ImportTeachersFormPage() {
  return (
    <div className="flex flex-col gap-5">
      <div className="flex items-center gap-3">
        <Link href="/app/teachers"><Button variant="ghost" size="icon-sm"><ArrowLeft className="w-4 h-4" /></Button></Link>
        <div>
          <h1 className="text-xl font-bold font-display text-ink">Import Teachers</h1>
          <p className="text-sm text-mid mt-0.5">Bulk import teacher records</p>
        </div>
      </div>
