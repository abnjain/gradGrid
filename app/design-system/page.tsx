            ...
            <Card>
              ...
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Student ID Card */}
                  <div className="border-2 border-primary rounded-lg p-6 bg-gradient-to-br from-blue-50 to-blue-100 max-w-sm">
                  ...
                  {/* Staff ID Card */}
                  <div className="border-2 border-amber-600 rounded-lg p-6 bg-gradient-to-br from-amber-50 to-amber-100 max-w-sm">
                    <div className="flex items-start justify-between mb-4">
                      <div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full px-3 py-2 border border-input rounded-md bg-background">
                    ...
                    <option selected>Class 12-A</option>
